		...
		if (user[1] ~= nil) then
			...
			function (licenses)
				...
				if show then
					...
					TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'Anda Tidak Mempunyai Lisensi' })
				end
			end)
		end
	end)
...
ESX.RegisterUsableItem('ktp', function(source)
   ...
   TriggerClientEvent('memperlihatkan:identity', source)
end)
...
ESX.RegisterUsableItem('permis', function(source)
   ...
   TriggerClientEvent('memperlihatkan:permis', source)
end)
...
ESX.RegisterUsableItem('ppa', function(source)
   ...
   TriggerClientEvent('memperlihatkan:ppa', source)
end)
